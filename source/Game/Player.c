...
void player_draw_tile (Player* self, Tile* t) {
	...
	if (!self->priv->_computer_player) {
		...
		if (_tmp0_ <= 1) {
			...
			Vector* _tmp3_ = NULL;
			Vector* _tmp4_;
			_tmp1_ = vector_new ((TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2)) + TILE_TILE_SPACING, -2.6f, (TILE_TILE_WIDTH / 2) - 0.05f);
			_tmp2_ = _tmp1_;
			tile_set_position (t, _tmp2_);
			_vector_unref0 (_tmp2_);
			_tmp3_ = vector_new ((gfloat) 40, (gfloat) 0, (gfloat) 90);
			_tmp4_ = _tmp3_;
			...
			if (_tmp5_ <= 4) {
				...
				Vector* _tmp8_ = NULL;
				Vector* _tmp9_;
				_tmp6_ = vector_new (TILE_TILE_HEIGHT / 2, self->priv->hand_height, (TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2)) - 0.14f);
				_tmp7_ = _tmp6_;
				...
				_tmp11_ = vector_new (((TILE_TILE_WIDTH + TILE_TILE_SPACING) * ((_tmp10_ - 2) / 2.0f)) + (TILE_TILE_HEIGHT / 2), self->priv->hand_height, (TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2)) - 0.14f);
				_tmp12_ = _tmp11_;
				tile_set_position (t, _tmp12_);
				_vector_unref0 (_tmp12_);
				_tmp13_ = vector_new ((gfloat) 40, (gfloat) 0, (gfloat) 90);
				_tmp14_ = _tmp13_;
		...
		gint _tmp15_;
		_tmp15_ = gee_collection_get_size ((GeeCollection*) self->priv->_hand);
		if (_tmp15_ <= 1) {
			Vector* _tmp16_ = NULL;
			Vector* _tmp17_;
			Vector* _tmp18_ = NULL;
			Vector* _tmp19_;
			_tmp16_ = vector_new ((TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2)) + TILE_TILE_SPACING, -2.7f, TILE_TILE_WIDTH / 2);
			_tmp17_ = _tmp16_;
			tile_set_position (t, _tmp17_);
			_vector_unref0 (_tmp17_);
			_tmp18_ = vector_new ((gfloat) 90, (gfloat) 0, (gfloat) 90);
			_tmp19_ = _tmp18_;
			tile_set_rotation (t, _tmp19_);
			_vector_unref0 (_tmp19_);
		} else {
			gint _tmp20_;
			_tmp20_ = gee_collection_get_size ((GeeCollection*) self->priv->_hand);
			if (_tmp20_ <= 4) {
				Vector* _tmp21_ = NULL;
				Vector* _tmp22_;
				Vector* _tmp23_ = NULL;
				Vector* _tmp24_;
				_tmp21_ = vector_new (TILE_TILE_HEIGHT / 2, -2.7f, TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2));
				_tmp22_ = _tmp21_;
				tile_set_position (t, _tmp22_);
				_vector_unref0 (_tmp22_);
				_tmp23_ = vector_new ((gfloat) 90, (gfloat) 0, (gfloat) 90);
				_tmp24_ = _tmp23_;
				tile_set_rotation (t, _tmp24_);
				...
				Vector* _tmp28_ = NULL;
				Vector* _tmp29_;
				_tmp25_ = gee_collection_get_size ((GeeCollection*) self->priv->_hand);
				_tmp26_ = vector_new (((TILE_TILE_WIDTH + TILE_TILE_SPACING) * ((_tmp25_ - 2) / 2.0f)) + (TILE_TILE_HEIGHT / 2), -2.7f, TILE_TILE_HEIGHT + (TILE_TILE_WIDTH / 2));
				_tmp27_ = _tmp26_;
				tile_set_position (t, _tmp27_);
				_vector_unref0 (_tmp27_);
				_tmp28_ = vector_new ((gfloat) 90, (gfloat) 0, (gfloat) 90);
				_tmp29_ = _tmp28_;
				tile_set_rotation (t, _tmp29_);
...
gboolean player_call_decision (Player* self, Tile* discard_tile, gboolean can_chi) {
	...
	if (self->priv->_computer_player) {
		Obj* _tmp10_ = NULL;
		Obj* _tmp11_;
		_tmp10_ = obj_new (G_TYPE_BOOLEAN, NULL, NULL, GINT_TO_POINTER (can_chi));
		_tmp11_ = _tmp10_;
		threading_start3 (_player_call_decision_thread_threading_del3_arg, NULL, (GObject*) self, (GObject*) discard_tile, (GObject*) _tmp11_);
...
static void player_call_decision_thread (GObject* player_obj, GObject* tile_obj, GObject* can_chi_obj) {
	...
	_tmp0_ = _g_object_ref0 (PLAYER (player_obj));
	p = _tmp0_;
	...
	_tmp4_ = _tmp3_;
	player_set_call_action (p, _tmp4_);
...
gboolean player_turn_decision (Player* self) {
	...
	if (_tmp0_) {
		...
		Tile* _tmp7_;
		TurnAction* _tmp8_ = NULL;
		TurnAction* _tmp9_;
		_tmp5_ = gee_collection_get_size ((GeeCollection*) self->priv->_hand);
		_tmp6_ = gee_abstract_list_get ((GeeAbstractList*) self->priv->_hand, _tmp5_ - 1);
		_tmp7_ = (Tile*) _tmp6_;
		_tmp8_ = turn_action_new_discard (_tmp7_);
		_tmp9_ = _tmp8_;
		player_set_turn_action (self, _tmp9_);
		_turn_action_unref0 (_tmp9_);
	...
	_tmp10_ = player_get_in_riichi (self);
	if (_tmp10_) {
		gboolean _tmp11_ = FALSE;
		gboolean _tmp12_;
		_tmp12_ = logic_can_riichi_closed_kan (self->priv->_hand);
		if (_tmp12_) {
			_tmp11_ = TRUE;
		} else {
			gboolean _tmp13_;
			_tmp13_ = logic_winning_hand (self->priv->_hand);
			_tmp11_ = _tmp13_;
		}
		result = _tmp11_;
		return result;
		...
		gboolean _tmp17_;
		_tmp17_ = logic_can_closed_kan (self->priv->_hand);
		if (_tmp17_) {
			_tmp16_ = TRUE;
		} else {
			gboolean _tmp18_;
			_tmp18_ = logic_can_late_kan (self->priv->_hand, self->priv->_pons);
			_tmp16_ = _tmp18_;
		}
		if (_tmp16_) {
			_tmp15_ = TRUE;
			...
			gboolean _tmp20_;
			_tmp20_ = player_get_open_hand (self);
			if (!_tmp20_) {
				GeeArrayList* _tmp21_ = NULL;
				GeeArrayList* _tmp22_;
				gint _tmp23_;
				_tmp21_ = logic_can_tenpai (self->priv->_hand);
				_tmp22_ = _tmp21_;
		...
		if (_tmp15_) {
			...
			gboolean _tmp24_;
			_tmp24_ = logic_winning_hand (self->priv->_hand);
			_tmp14_ = _tmp24_;
		}
		result = _tmp14_;
		return result;
...
static void player_turn_decision_thread (GObject* player_obj) {
	...
	_tmp2_ = _tmp1_;
	player_set_turn_action (p, _tmp2_);
	_turn_action_unref0 (_tmp2_);
	if (p->priv->_turn_action != NULL) {
		player_set_state (p, PLAYER_PLAYER_STATE_READY);
	}
	_g_object_unref0 (p);
}
	...
	tile_sort_tiles (self->priv->_hand);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp8_ = gee_abstract_list_get ((GeeAbstractList*) self->priv->_hand, i);
				_tmp9_ = (Tile*) _tmp8_;
				_tmp10_ = vector_new ((gfloat) _tmp7_, (gfloat) 0, (gfloat) 0);
				_tmp11_ = _tmp10_;
				tile_set_rotation (_tmp9_, _tmp11_);
				_vector_unref0 (_tmp11_);
...
gboolean player_get_computer_player (Player* self) {
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
	result = self->priv->_computer_player;
	return result;
}
...
void player_set_computer_player (Player* self, gboolean value) {
	g_return_if_fail (self != NULL);
	self->priv->_computer_player = value;
