...
public class Tile : Object
{
    ...
    public Tile(float size, int id, int type)
    {
        ...
        if (type <= TILE_TYPE.MAN9)
            name = "Man" + (type+1).to_string();
        else if (type <= TILE_TYPE.PIN9)
            name = "Pin" + ((type%9)+1).to_string();
        else if (type <= TILE_TYPE.SOU9)
            name = "Sou" + ((type%9)+1).to_string();
        else if (type == TILE_TYPE.HIGASHI)
            name = "Higashi";
        else if (type == TILE_TYPE.MINAMI)
            name = "Minami";
        else if (type == TILE_TYPE.NISHI)
            name = "Nishi";
        else if (type == TILE_TYPE.KITA)
            name = "Kita";
        else if (type == TILE_TYPE.HAKU)
            name = "Haku";
        else if (type == TILE_TYPE.HATSU)
            name = "Hatsu";
        else if (type == TILE_TYPE.CHUN)
            name = "Chun";
        else
            name = "";
