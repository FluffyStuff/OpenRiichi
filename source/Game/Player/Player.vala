...
public class Player : Object
{
    ...
    protected float hand_height = -2.43f;
    ...
    public virtual void draw_tile(Tile t)
    {
        if (hand.size <= 1)
        {
    ...
    public virtual bool call_decision(Tile discard_tile, bool can_chi)
    {
    ...
    public virtual bool turn_decision()
    {
        if (in_riichi &&
    ...
    public virtual void arrange_hand()
    {
        ...
        for (int i = 0; i < hand.size; i++)
        {
            ...
            hand[i].rotation = new Vector(90, 0, 0);
        }
    }
    ...
    public virtual CallAction? call_action { get; set; }
    public virtual TurnAction? turn_action { get; set; }
