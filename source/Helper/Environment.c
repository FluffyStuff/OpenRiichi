...
static guint32 environment__version_major;
static guint32 environment__version_major = 0U;
static guint32 environment__version_minor;
static guint32 environment__version_minor = 0U;
static guint32 environment__version_revision;
static guint32 environment__version_revision = 0U;
...
static void environment_set_version_major (guint32 value);
static void environment_set_version_minor (guint32 value);
static void environment_set_version_revision (guint32 value);
...
gboolean environment_init (guint32 major, guint32 minor, guint32 revision) {
	...
	_tmp2_ = SDL_CreateWindow ("Riichi Mahjong", (gint) SDL_WINDOWPOS_CENTERED_MASK, (gint) SDL_WINDOWPOS_CENTERED_MASK, ENVIRONMENT_ORIGINAL_WINDOW_WIDTH, ENVIRONMENT_ORIGINAL_WINDOW_HEIGHT, (guint32) (SDL_WINDOW_RESIZABLE | SDL_WINDOW_OPENGL));
	_SDL_free0 (environment_window);
	environment_window = _tmp2_;
	...
	environment_set_version_major (major);
	environment_set_version_minor (minor);
	environment_set_version_revision (revision);
...
guint32 environment_get_version_major (void) {
	guint32 result;
	result = environment__version_major;
	return result;
}


static void environment_set_version_major (guint32 value) {
	environment__version_major = value;
}


guint32 environment_get_version_minor (void) {
	guint32 result;
	result = environment__version_minor;
	return result;
}


static void environment_set_version_minor (guint32 value) {
	environment__version_minor = value;
}


guint32 environment_get_version_revision (void) {
	guint32 result;
	result = environment__version_revision;
	return result;
}


static void environment_set_version_revision (guint32 value) {
	environment__version_revision = value;
}
