Linux:
	valac -D LINUX --save-temps -g --thread --target-glib 2.32 --pkg glib-2.0 --pkg glew --pkg gee-1.0 --pkg gl --pkg sdl2-mixer --pkg sdl2-image --pkg sdl2 *.vala bot/*.vala --pkg SOIL -o bin/RiichiMahjong --vapidir=vapi -X /usr/lib/libSOIL.so -X /usr/local/lib/libSDL2_image.a -X /usr/local/lib/libSDL2_mixer.a -X lib/SDL/SDL2.lib -X lib/GLEW/glew32s.lib -X lib/GL/libopengl32.a
